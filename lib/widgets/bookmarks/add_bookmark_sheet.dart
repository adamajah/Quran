                ...
                Expanded(
                  child: ListView.builder(
                    ...
                    itemBuilder: (context, index) {
                      ...
                      return ListTile(
                        title: Text(
                          '$sNum. ${q.getSurahName(sNum)}',
                          style: TextStyle(fontSize: 14, color: textColor),
                        ),
                        trailing: Text(
                          '${q.getVerseCount(sNum)} Ayat',
                          style: TextStyle(
                            fontSize: 12,
                        ...
                        child: Container(
                          ...
                          child: Center(
                            child: Text(
                              ...
                              style: TextStyle(
                                color:
                                    _verse == vNum ? Colors.white : textColor,
                                fontWeight: FontWeight.bold,
                              ),
                            ),
                          ),
  ...
  Widget _buildColorSelector(Color cardBg) {
    return Row(
      children: [
        ...
        ..._colors.map((c) {
          final active = _highlightColor == c.toARGB32();
          return GestureDetector(
            onTap: () => setState(() => _highlightColor = c.toARGB32()),
            child: Container(
              width: 32,
              height: 32,
              margin: const EdgeInsets.only(right: 12),
              decoration: BoxDecoration(
                ...
                shape: BoxShape.circle,
                border:
                    active ? Border.all(color: Colors.white, width: 2) : null,
                boxShadow:
                    active
                        ? [
                          BoxShadow(
