    ...
    return Container(
      ...
      child: Column(
        ...
        children: [
            ...
            children: [
              Expanded(
                child: Align(
                  ...
                  child: _StatBadge(label: 'Salah', value: '$mistakes', color: mistakes > 0 ? Colors.red : Colors.grey),
                ),
              ),
              Expanded(
                child: Center(
                    ...
                    children: [
                      ...
                      Text(
                        ...
                        style: TextStyle(
                          ...
                          color: isRecording ? Colors.green : Colors.grey.withOpacity(0.6),
                          letterSpacing: 0.5,
                        ),
                      ),
                    ],
          ...
          Row(
            children: [
              Expanded(child: Center(child: _ActionBtn(
...
class _ActionBtn extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    final isDark = Theme.of(context).brightness == Brightness.dark;
    final defaultColor = isDark ? Colors.white.withOpacity(0.7) : AppColors.dark.withOpacity(0.6);
    ...
    return InkWell(
      ...
      child: Column(
        children: [
          ...
          Text(label, style: TextStyle(fontSize: 9, color: color ?? defaultColor.withOpacity(0.8))),
        ],
      ),
    );
  }
...
class _WaveformSimulatorState extends State<_WaveformSimulator> with SingleTickerProviderStateMixin {
