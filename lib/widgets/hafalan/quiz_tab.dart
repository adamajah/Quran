          ...
          child: Column(
            ...
            children: [
              ...
              DropdownButtonFormField<int>(
                ...
                items: List.generate(q.totalSurahCount, (i) => i + 1)
                    .map((s) => DropdownMenuItem(
                        value: s, child: Text('$s. ${q.getSurahName(s)}')))
                    .toList(),
                onChanged: (v) {
        ...
        child: Row(children: [
          ...
          Expanded(
            ...
            child: LinearProgressIndicator(
              ...
              minHeight: 7,
              backgroundColor: isDark ? Colors.white10 : AppColors.clrBelum.withOpacity(0.15),
        ...
        child: Column(children: [
          Container(
            ...
            decoration: BoxDecoration(
              ...
              boxShadow: [
                BoxShadow(
                    color: (isDark ? Colors.black : AppColors.dark).withOpacity(0.08),
                    blurRadius: 8,
            ...
            child: Column(children: [
              ...
              Text(
                ...
                style: QuranLibrary().hafsStyle.copyWith(
                    fontSize: 22, height: 1.85, color: textColor),
          ...
          ...q_.options.map((opt) {
            ...
            if (selectedAnswer != null) {
              if (isCorrect) {
                bgColor = AppColors.clrHafal.withOpacity(0.12);
              ...
              child: AnimatedContainer(
                ...
                child: Row(children: [
                  ...
                  Expanded(
                      child: Text(opt,
                          style: QuranLibrary().hafsStyle.copyWith(
                              fontSize: 18, height: 1.7, color: textColor),
                          textDirection: TextDirection.rtl)),
                ]),
              ),
            );
