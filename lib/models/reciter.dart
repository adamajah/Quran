class Reciter {
  ...
  bool get supportsVerseAudio => true;
...
const List<Reciter> availableReciters = [
  ...
  Reciter(
    ...
    bitrate: 128,
    surahAudioId: 'ar.abdullahbasfar',
    surahAudioBitrate: 128,
  ),
  Reciter(
  ...
  Reciter(
    ...
    bitrate: 128,
    surahAudioId: 'ar.husarymujawwad',
    surahAudioBitrate: 128,
  ),
  Reciter(
    name: 'Hudhaify',
