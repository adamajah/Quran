...
class _OfflineDownloadScreenState extends State<OfflineDownloadScreen> {
  ...
  Widget _buildAllSurahSection(BuildContext context) {
    ...
    return Column(
      ...
      children: [
        ...
        const Text(
          'Pilih surat, lalu tentukan qari yang ingin didownload.',
          ...
          child: Row(
            children: [
              ...
              if (isDownloaded)
                ...
                GestureDetector(
                  onTap: () => _showReciterPicker(context, surah),
                  child: const Icon(
  ...
  Future<void> _showReciterPicker(BuildContext context, int surah) async {
    final isDark = Theme.of(context).brightness == Brightness.dark;
    final textColor = isDark ? Colors.white : AppColors.dark;
